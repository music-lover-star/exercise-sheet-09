...
public class OverloadedUsageTest {
    ...
    public static void main(final String[] args) {
        // Create an entity libraryOfAlexandria and stuttgartOperaHouse of type Library and Opera and reference a new library and opera respectively
        
        // Call this class' static print building info and pass libraryOfAlexandria and stuttgartOperaHouse
        
        // Create entities building1 and building2 of type Building and let them reference libraryOfAlexandria and stuttgartOperaHouse
        // Call this class' static print building info and pass each of the building entities
    }
